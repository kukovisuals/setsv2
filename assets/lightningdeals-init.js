...
***/  
    ...
    **/
    let updateHeaderModule = function(optSelection) {
      	...
      	console.log(':: Init headerModule update :: offline');
...
//           	let globalBannerImg = window.innerWidth < 770 ? document.getElementById('flashsale-all_styles_banner-mobile').getAttribute('src') : document.getElementById('flashsale-all_styles_banner-desktop').getAttribute('src');
//           	let baseImgUrl = globalBannerImg.substr(0, globalBannerImg.indexOf('lastcall---'));
